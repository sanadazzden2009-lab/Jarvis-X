        ...
        content=ft.Row(
            [
                ft.IconButton(
                    ...
                    on_click=lambda e: on_menu_click(),
                    tooltip="Menu",
                ),
                ft.Text("JARVIS X", size=16, weight=ft.FontWeight.BOLD, color=theme.TEXT_PRIMARY),
                ft.Container(width=10),
                hud_indicator("Provider", "Groq", status="online", icon=ft.icons.CLOUD),
                hud_indicator("Model", "gpt-oss-120b", status="online", icon=ft.icons.MEMORY),
                hud_indicator("Latency", "--", status="processing", icon=ft.icons.SPEED),
            ],
            spacing=16,
